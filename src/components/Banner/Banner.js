...
export const Banner = () => {
    ...
    const onDownloadClick = () => {
        ...
        const pdfUrl = 'https://drive.google.com/file/d/1Ao1DLskwS4cwGScMBI8yI4OpC1Vo4lAy/view?usp=sharing';
                        ...
                        <TrackVisibility>
                            {({ isVisible }) =>
                                <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                                    ...
                                    <h1>{`Hi! I'm Mihir Dharaiya`}<br /> <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Data Analyst" ]'><span className="wrap">{text}</span></span></h1>
                                    <p>
